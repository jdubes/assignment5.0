...
<html lang="en-US">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="all" href="styletest.css">
        <link rel="stylesheet" type="text/css" media="all" href="sliderstyle.css">
    ...
    <body>
        <div id="caption" >
            ...
            <div class="caption">
                <a href="intro.php"> <figure id="slidy"> <!--slider taken from codepen.io-->
                ...
                <div class="mask">
                    <a href="intro.php" class="info">Let's eat!</a>
                </div>
                <!--ideas taken from codepen.io--> 
            </div>
        </div>
        <script>
